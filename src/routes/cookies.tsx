...
function CookiesPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-10 prose prose-sm dark:prose-invert">
      ...
      <ul>
        <li><strong>Essential cookies</strong> — keep you signed in and protect your account (cannot be disabled).</li>
        <li><strong>Preference storage</strong> — remembers your theme, dark mode, and last activity.</li>
        <li><strong>Performance</strong> — anonymized data to keep the site fast and stable.</li>
      </ul>
      ...
      <h2>Contact</h2>
      <p>
        Questions? Send us a note via the <Link to="/feedback" className="text-primary hover:underline">feedback page</Link>.
      </p>
    </div>
  );
}
